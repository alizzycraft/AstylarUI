...
Continue from fresh baselines for nested block/control/image content, mixed intrinsic tracks, and intrinsic keywords and bounds. Remove dashboard row-height declarations only after the underlying contribution behavior is covered and green.
