...
Seven entries deliberately point at existing parity fixtures rather than copying
...
It enforces the ten required topics, source completeness, classifications,
...
the rendering/behavior gate for the seven fixture-backed pairs, while
