...
| 757 | Root initial-style evidence index | After complete replay established unchanged 2,311 cases / 30,043 observations / 468 groups, only the two stale receipts were refreshed. Every non-receipt field remains identical and the unchanged full test file passes 5/5. See `material-root-initial-receipt-diagnostic.md`. |
