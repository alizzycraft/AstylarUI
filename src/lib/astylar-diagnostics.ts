...
export type AstylarDiagnosticCode =
  ...
  | 'plugin-async-resource-failed'
  | 'plugin-resource-cleanup-failed'
  | 'plugin-invalidation-invalid'
  | 'plugin-invalidation-recursive'
  | 'plugin-invalidation-failed'
  | 'plugin-migration-invalid'
  | 'plugin-migration-duplicate'
  | 'plugin-migration-cycle'
  | 'plugin-migration-path-missing'
...
const styleProperties = new Set([
  ...
  'onclick', 'color', 'caretColor', 'fontFamily', 'fontSize', 'fontWeight', 'fontStyle',
  'textAlign', 'verticalAlign', 'lineHeight', 'letterSpacing', 'wordSpacing',
  'whiteSpace', 'wordWrap', 'textOverflow', 'overflow', 'textShadow',
  'textDecoration', 'textTransform', 'textStroke', 'cursor', 'pointerEvents', 'display',
