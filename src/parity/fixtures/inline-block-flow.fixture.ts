...
export const inlineBlockFlowFixture: ParityFixture = {
  ...
  expectedBehavior: 'Inline-block siblings share a line and display:none contributes neither rendering nor layout space.',
  measurementIds: ['inline-parent', 'inline-one', 'inline-two'],
  expectedAbsentIds: ['inline-hidden'],
  reference: {
    html: '<div id="inline-parent"><span id="inline-one">One</span><span id="inline-hidden">Hidden</span><span id="inline-two">Two</span></div>',
    css: `
