...
export const representativeProjectDashboardFixture: ParityFixture = {
  ...
  reference: {
    ...
    css: `
      ...
      #pm-summary span { height:40px; font:400 12px/20px Arial,sans-serif; }
      ...
      #pm-activity { width:168px; height:464px; padding:12px; background:#ffffff; overflow:hidden; }
      ...
      @media (min-width:600px) and (max-width:749px) {
        ...
        #pm-summary article { height:84px; padding:8px 12px; } #pm-summary strong { height:28px; font-size:20px; line-height:28px; } #pm-summary span { height:20px; white-space:nowrap; }
        ...
        #pm-activity { width:124px; height:584px; padding:10px; } #pm-activity-title, #pm-activity-list { width:104px; }
      ...
      @media (max-width:599px) {
        ...
        #pm-summary article { height:130px; padding:10px; } #pm-summary strong { height:32px; font-size:20px; } #pm-summary span { height:60px; }
  ...
  siteData: {
    styles: [
      ...
      { selector:'#pm-summary span', height:'40px', fontFamily:'Arial, sans-serif', fontSize:'12px', lineHeight:'20px' },
      ...
      { selector:'#pm-activity', width:'168px', height:'464px', padding:'12px', background:'#ffffff', overflow:'hidden' },
      ...
      { selector:'#pm-summary article', mediaMinWidth:'600px', mediaMaxWidth:'749px', height:'84px', padding:'8px 12px' }, { selector:'#pm-summary strong', mediaMinWidth:'600px', mediaMaxWidth:'749px', height:'28px', fontSize:'20px', lineHeight:'28px' }, { selector:'#pm-summary span', mediaMinWidth:'600px', mediaMaxWidth:'749px', height:'20px', whiteSpace:'nowrap' },
      ...
      { selector:'#pm-activity', mediaMinWidth:'600px', mediaMaxWidth:'749px', width:'124px', height:'584px', padding:'10px' }, { selector:'#pm-activity-title, #pm-activity-list', mediaMinWidth:'600px', mediaMaxWidth:'749px', width:'104px' },
      ...
      { selector:'#pm-summary strong', mediaMaxWidth:'599px', height:'32px', fontSize:'20px' }, { selector:'#pm-summary span', mediaMaxWidth:'599px', height:'60px' },
