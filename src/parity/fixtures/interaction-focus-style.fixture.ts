...
export const interactionFocusStyleFixture: ParityFixture = {
  ...
  expectedBehavior:
    'Focusing a control applies authored focus paint and blurring it restores normal paint without changing geometry.',
  ...
  reference: {
    html: `<input id="focus-style-target" type="text" value="Ready"><div id="focus-style-outside"></div>`,
    css: `
      ...
      #focus-style-target:focus { background:#93c5fd; }
  ...
  siteData: {
    styles: [
      ...
      { selector: '#focus-style-target:focus', background: '#93c5fd' },
      {
    ...
    root: { children: [
      { type: 'input', inputType: 'text', id: 'focus-style-target', value: 'Ready' },
