...
export const representativeAccountSettingsFixture: ParityFixture = {
  ...
  reference: {
    ...
    css: `
      ...
      #as-profile-fields { display:flex; flex-direction:column; gap:4px; position:relative; width:368px; height:234px; margin:0; padding:32px 10px 10px; border:1px solid #cbd5e1; background:#ffffff; overflow:hidden; }
      ...
      #as-bio-row { flex-basis:58px; height:58px; align-items:flex-start; } #as-bio-row > label { height:58px; } #as-bio { height:58px; padding:5px 9px; white-space:pre-wrap; }
      ...
      @media (min-width:600px) and (max-width:749px) {
        ...
        #as-form-intro { height:36px; } #as-profile-fields { height:216px; } .as-field-row { flex-basis:36px; width:410px; height:36px; } .as-field-row > label { flex-basis:96px; width:96px; height:36px; padding:6px 0; }
        .as-field-row > input, .as-field-row > select, .as-field-row > textarea { flex-basis:308px; width:308px; height:36px; padding:5px 9px; } #as-bio-row { flex-basis:52px; } #as-bio-row, #as-bio-row > label, #as-bio { height:52px; }
  ...
  siteData: {
    styles: [
      ...
      { selector:'#as-bio-row', flexBasis:'58px', height:'58px', alignItems:'flex-start' }, { selector:'#as-bio-row > label', height:'58px' }, { selector:'#as-bio', height:'58px', padding:'5px 9px', whiteSpace:'pre-wrap' }, { selector:'#as-name:required', borderColor:'#dc2626' }, { selector:'#as-email:read-only', background:'#e2e8f0', color:'#64748b' },
      ...
      { selector:'#as-form', mediaMinWidth:'600px', mediaMaxWidth:'749px', flex:'0 0 430px', width:'456px', height:'430px' }, { selector:'#as-form-intro, #as-form-intro h1, #as-form-intro p, #as-profile-fields, #as-help, #as-preferences, #as-actions', mediaMinWidth:'600px', mediaMaxWidth:'749px', width:'432px' }, { selector:'#as-form-intro', mediaMinWidth:'600px', mediaMaxWidth:'749px', height:'36px' }, { selector:'#as-profile-fields', mediaMinWidth:'600px', mediaMaxWidth:'749px', height:'216px' },
      { selector:'.as-field-row', mediaMinWidth:'600px', mediaMaxWidth:'749px', flexBasis:'36px', width:'410px', height:'36px' }, { selector:'.as-field-row > label', mediaMinWidth:'600px', mediaMaxWidth:'749px', flex:'0 0 96px', width:'96px', height:'36px', padding:'6px 0' }, { selector:'.as-field-row > input, .as-field-row > select, .as-field-row > textarea', mediaMinWidth:'600px', mediaMaxWidth:'749px', flex:'0 0 308px', width:'308px', height:'36px', padding:'5px 9px' }, { selector:'#as-bio-row', mediaMinWidth:'600px', mediaMaxWidth:'749px', flexBasis:'52px' }, { selector:'#as-bio-row, #as-bio-row > label, #as-bio', mediaMinWidth:'600px', mediaMaxWidth:'749px', height:'52px' },
