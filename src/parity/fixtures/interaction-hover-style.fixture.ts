...
export const interactionHoverStyleFixture: ParityFixture = {
  ...
  reference: {
    ...
    css: `
      ...
      #hover-style-target { box-sizing:border-box; position:absolute; left:170px; top:210px; width:220px; height:100px; border:4px solid #1e3a8a; border-radius:12px; background:#dbeafe; }
      #hover-style-target:hover { background:#2563eb; }
  ...
  siteData: {
    styles: [
      ...
      { selector: '#hover-style-target:hover', background: '#2563eb' },
      {
