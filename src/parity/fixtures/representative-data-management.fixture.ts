...
export const representativeDataManagementFixture: ParityFixture = {
  ...
  reference: {
    ...
    css: `
      ...
      #dm-detail-body { display:flex; flex-direction:column; gap:8px; width:172px; height:268px; }
      ...
      @media (min-width:600px) and (max-width:749px) {
        ...
        #dm-detail-body { gap:4px; width:296px; height:154px; }
      ...
      @media (max-width:599px) {
        ...
        #dm-detail-body { gap:6px; width:204px; height:222px; }
  ...
  siteData: {
    styles: [
      ...
      { selector:'#dm-detail-body', display:'flex', flexDirection:'column', gap:'8px', width:'172px', height:'268px' },
      ...
      { selector:'#dm-detail', mediaMaxWidth:'599px', flexDirection:'row', gap:'10px', left:'10px', top:'418px', width:'350px', height:'246px', padding:'12px' }, { selector:'#dm-detail-image', mediaMaxWidth:'599px', width:'112px', height:'96px' }, { selector:'#dm-detail-body', mediaMaxWidth:'599px', gap:'6px', width:'204px', height:'222px' },
