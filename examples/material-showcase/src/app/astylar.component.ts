    ...
    return {
      ...
      styles: [
        ...
        ...(theme.density === -2 ? [
          ...
          { selector: '.select-popup', top: '49px', left: '0', width: '100%', height: '112px' },
        ...
        ...(theme.density <= -5 ? [
          { selector: '.select-popup', top: '46px', left: '7px', right: 'auto', width: 'calc(100% - 14px)' },
        ...
        ...(theme.density === -2 ? [
          { selector: '.datepicker-popup', top: '49.5px', height: '350.5px' },
