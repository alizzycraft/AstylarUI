  ...
  private buildSiteData(family: MaterialFamily): SiteData {
    ...
    return {
      ...
      styles: [
        ...
        { selector: '.grid-tile-label', position: 'absolute', top: `${theme.density <= -5 ? devicePixelRatio >= 1.5 ? 31.5 : 32 : theme.typographyScale > 1 ? 28 : 30}px`, left: '0', width: '100%', textAlign: 'center', whiteSpace: 'nowrap' },
        ...(family === 'grid-list' && theme.density <= -5 ? [{ selector: '.grid-tile-label', mediaMaxWidth: '500px', top: '31px' }] : []),
        ...(family === 'grid-list' && theme.typographyScale > 1 ? [{ selector: '.grid-tile-label', mediaMaxWidth: '500px', top: '27.5px' }] : []),
