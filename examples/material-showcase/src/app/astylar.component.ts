  ...
  private buildSiteData(family: MaterialFamily): SiteData {
    ...
    return {
      ...
      styles: [
        ...
        { selector: '.step-tab', position: 'absolute', top: '0', width: '130px', height: `${theme.density === 0 ? 72 : theme.density <= -5 ? 48 : 64}px`, boxSizing: 'border-box', borderRadius: `${12 * theme.cornerScale}px` },
