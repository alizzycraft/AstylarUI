  ...
  private buildSiteData(family: MaterialFamily): SiteData {
    ...
    return {
      ...
      styles: [
        ...
        { selector: '.expansion-panel', position: 'relative', width: '100%', height: `${state.open ? theme.density === 0 ? 136 : theme.density <= -5 ? 120 : 128 : theme.density === 0 ? 48 : theme.density <= -5 ? 36 : 40}px`, borderRadius: `${12 * theme.cornerScale}px`, background: theme.surface, boxShadow: theme.density <= -5 ? `0 2px 1px -1px rgba(0,0,0,0.2), 0 1px 1px 0 rgba(0,0,0,0.14), 0 1px 3px 0 rgba(0,0,0,${state.open ? .45 : .12})` : '0 1px 2px #00000055' },
        ...
        { selector: '.expansion-trigger:focus, .expansion-trigger:hover', background: state.open ? 'transparent' : mixHex(theme.surface, theme.onSurface, .08) },
