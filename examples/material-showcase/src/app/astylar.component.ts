...
export class AstylarShowcaseComponent {
  ...
  private buildSiteData(family: MaterialFamily): SiteData {
    ...
    return {
      ...
      styles: [
        ...
        { selector: '.stepper-head', position: 'relative', width: '100%', height: `${theme.density === 0 ? 72 : theme.density <= -5 ? 42 : 64}px` },
        ...
        { selector: '.step-tab', position: 'absolute', zIndex: '2', top: '0', width: '130px', height: `${theme.density === 0 ? 72 : theme.density <= -5 ? 42 : 64}px`, boxSizing: 'border-box', padding: '0 24px', borderRadius: `${12 * theme.cornerScale}px`, display: 'flex', alignItems: 'center', cursor: 'pointer' },
        ...
        { selector: '.stepper-content-container', boxSizing: 'border-box', padding: '0 0 24px', margin: '0', textAlign: 'left' },
        { selector: '#stepper-content', textAlign: 'left' },
  ...
  private familyElements(family: MaterialFamily): DOMElement[] {
    ...
    if (family === 'stepper') return [{ type: 'div', id: 'stepper-primary', class: 'stepper', role: 'tablist', ariaLabel: 'Project setup', children: [{ type: 'div', id: 'stepper-head', class: 'stepper-head', children: [{ type: 'div', id: 'step-details', class: 'step-tab', role: 'tab', tabindex: state.selected ? 0 : -1, ariaSelected: state.selected, children: [{ type: 'span', id: 'step-details-badge', class: `step-badge${state.selected ? ' selected' : ' completed'}`, children: state.selected ? undefined : [this.selectionMark('step-details-complete', 'step-complete-mark')], textContent: state.selected ? '1' : undefined }, { type: 'span', id: 'step-details-text', class: 'step-text', textContent: 'Details' }] }, { type: 'span', id: 'step-connector', class: 'step-connector' }, { type: 'div', id: 'step-review', class: 'step-tab', role: 'tab', tabindex: state.selected ? -1 : 0, ariaSelected: !state.selected, children: [{ type: 'span', id: 'step-review-badge', class: `step-badge${state.selected ? '' : ' selected'}`, textContent: '2' }, { type: 'span', id: 'step-review-text', class: 'step-text', textContent: 'Review' }] }] }, { type: 'div', id: 'stepper-content-container', class: 'stepper-content-container', children: [{ type: 'span', id: 'stepper-content', role: 'tabpanel', textContent: state.selected ? 'Project details' : 'Review changes' }] }] }];
...
interface MaterialBenchmarkMeasurement {
  ...
  readonly inputTree?: ReturnType<typeof collectAuthoredInputTree>;
}
