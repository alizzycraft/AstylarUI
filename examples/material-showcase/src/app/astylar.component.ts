  ...
  private buildSiteData(family: MaterialFamily): SiteData {
    ...
    return {
      ...
      styles: [
        ...
        ...(family === 'expansion' && theme.density <= -5 ? [{ selector: '.expansion-title', transform: 'translate(0, -0.85px)' }] : []),
        ...
        { selector: '.tab-baseline', position: 'absolute', zIndex: '1', top: `${theme.density === 0 ? 47 : theme.density <= -5 ? 32.5 : 39}px`, left: '0', width: '100%', height: '1px', background: '#e8e0eb' },
        { selector: '.tab-indicator', position: 'absolute', zIndex: '2', top: `${theme.density === 0 ? 46 : theme.density <= -5 ? 30.5 : 38}px`, left: state.selected ? '0' : '50%', width: '50.7%', height: '2px', background: theme.primary },
        ...
        { selector: '.step-tab:hover, .step-tab:focus', background: mixHex(theme.surface, theme.onSurface, .08) },
