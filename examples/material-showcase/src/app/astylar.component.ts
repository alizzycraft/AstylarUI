  ...
  private buildSiteData(family: MaterialFamily): SiteData {
    ...
    return {
      ...
      styles: [
        ...
        { selector: '.chip-label', padding: theme.density <= -5 ? '0' : '0 0 2px', verticalAlign: 'middle', transform: 'translateY(0.25px)' },
        ...
        ...(family === 'stepper' && theme.density === 0 ? [{ selector: '.step-text', transform: 'translate(0, -0.75px)' }] : []),
