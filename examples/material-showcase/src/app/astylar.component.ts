  ...
  private buildSiteData(family: MaterialFamily): SiteData {
    ...
    return {
      ...
      styles: [
        ...
        { selector: '.tab', width: '50%', height: `${theme.density === 0 ? 48 : theme.density <= -5 ? 32 : 40}px`, boxSizing: 'border-box', padding: '0', flexShrink: '0', borderWidth: '0', background: 'transparent', color: theme.onSurface, fontSize: '14px', fontWeight: '600', verticalAlign: 'middle' },
        { selector: '.tab-baseline', position: 'absolute', top: `${theme.density === 0 ? 47 : theme.density <= -5 ? 31 : 39}px`, left: '0', width: '100%', height: '1px', background: '#cac4d0' },
        ...
        { selector: '.tab-indicator', mediaMaxWidth: '500px', width: '51.9%' },
        ...
        { selector: '.step-tab', position: 'absolute', top: `${theme.density === 0 ? 12 : theme.density <= -5 ? -2 : 7}px`, height: '48px', display: 'flex', alignItems: 'center' },
        ...
        { selector: '.step-connector', position: 'absolute', top: `${theme.density === 0 ? 35 : theme.density <= -5 ? 21 : 30}px`, left: '89px', width: '73.2%', height: '1px', background: '#79747e' },
