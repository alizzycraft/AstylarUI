    ...
    role: 'button', tabindex: 0, ariaLabel: `Select ${item.title}`, children: [
      ...
      { type: 'footer', id: `history-${item.id}-actions`, children: [
        ...
        { type: 'button', inputType: 'button', id: `history-${item.id}-play`,
          class: playing ? 'item-action play-action transport-play playing' : 'item-action play-action transport-play',
          value: playing ? 'Pause' : '▷', ariaLabel: playing ? 'Pause' : 'Play' },
        { type: 'button', inputType: 'button', id: `history-${item.id}-download`, class: 'item-action download-action', value: '⇩', ariaLabel: `Download ${item.title}` },
        { type: 'button', inputType: 'button', id: `history-${item.id}-delete`, class: 'item-action delete-action', value: '♲', ariaLabel: `Delete ${item.title}` },
      ] },
    ],
  };
}
...
const styles: StyleRule[] = [
  ...
  { selector: 'input', cursor: 'text', fontFamily: 'Segoe UI, Arial, sans-serif', fontSize: '14px', lineHeight: '1.5' },
  { selector: 'select', cursor: 'pointer', fontFamily: 'Segoe UI, Arial, sans-serif', fontSize: '14px', lineHeight: '1.5' },
  { selector: 'textarea', cursor: 'text', fontFamily: 'Segoe UI, Arial, sans-serif', fontSize: '14px', lineHeight: '1.5' },
  { selector: 'button', cursor: 'pointer', fontFamily: 'Segoe UI, Arial, sans-serif', fontSize: '14px', lineHeight: '1.5' },
  ...
  { selector: '.setting-field select:focus, .setting-field input:focus', borderColor: '#1f6feb', boxShadow: '0 0 0 3px rgba(31,111,235,0.3)' },
  ...
  { selector: '#generation-title:focus', borderColor: '#1f6feb', boxShadow: '0 0 0 3px rgba(31,111,235,0.3)' },
  ...
  { selector: '#speech-text:focus', background: '#1e2a3a', color: '#f7fafc' },
  { selector: '#editor-bottom', display: 'flex', alignItems: 'center', justifyContent: 'space-between', minHeight: '56px', gap: '12px' },
  { selector: '#generate-speech', height: 'auto', margin: '0 0 0 auto', minWidth: '198px', padding: '14px 24px', background: '#238636', color: '#ffffff', fontWeight: '600', borderWidth: '0', borderRadius: '6px', cursor: 'pointer' },
  { selector: '#generate-speech:hover', background: '#2ea043', transform: 'translateY(-1px)' },
  { selector: '#generate-speech:active', transform: 'translateY(0)' },
  ...
  { selector: '#history-search:focus', borderColor: '#1f6feb', boxShadow: '0 0 0 2px rgba(31,111,235,0.3)' },
  ...
  { selector: '.history-item', position: 'relative', height: '133px', minHeight: '128px', margin: '0 8px', padding: '12px 16px', background: '#161b22', borderWidth: '1px', borderStyle: 'solid', borderColor: '#21262d', borderRadius: '6px', cursor: 'pointer' },
  { selector: '.history-item:hover', background: '#161b22', borderColor: '#30363d' },
  { selector: '.history-item:focus', background: '#161b22', boxShadow: '0 0 0 2px rgba(31,111,235,0.3)' },
  ...
  { selector: '.history-item button', width: '11px', height: '21px', background: 'transparent', color: '#7d8590', borderWidth: '0', borderRadius: '4px', cursor: 'pointer' },
  { selector: '.item-action:hover', background: '#21262d' },
  { selector: '.play-action:hover', color: '#238636' },
  { selector: '.download-action:hover', color: '#1f6feb' },
  { selector: '.delete-action:hover', color: '#f85149' },
