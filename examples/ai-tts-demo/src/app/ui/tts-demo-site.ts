...
const styles: StyleRule[] = [
  ...
  { selector: '#brand-header', margin: '0 0 34px 0' },
  ...
  { selector: '#workspace-header', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '20px', margin: '0 0 20px 0' },
  ...
  { selector: '#history-header', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '10px', margin: '0 0 16px 0' },
