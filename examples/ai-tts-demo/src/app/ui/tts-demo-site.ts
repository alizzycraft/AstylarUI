  ...
  return {
    ...
    role: 'button', tabindex: 0, ariaLabel: `Select ${item.title}`, children: [
      { type: 'small', id: `history-${item.id}-meta`, children: [
        { type: 'span', id: `history-${item.id}-provider`, textContent: `⚙　Openai　　● ${item.voice}` },
...
const styles: StyleRule[] = [
  ...
  { selector: '#settings-content', flex: '1', minHeight: '0', overflow: 'auto', padding: '17px 16px 15px', background: '#161b22' },
  ...
  { selector: '#selected-play', width: '32px', height: '32px', background: 'transparent', color: '#e6edf3', fontSize: '20px', borderWidth: '0' },
  ...
  { selector: '.history-item small', display: 'flex', justifyContent: 'space-between', color: '#7d8590' },
  ...
  { selector: '#history-footer', padding: '12px 16px', textAlign: 'center', color: '#7d8590', background: '#161b22', borderWidth: '1px 0 0 0', borderStyle: 'solid', borderColor: '#21262d' },
