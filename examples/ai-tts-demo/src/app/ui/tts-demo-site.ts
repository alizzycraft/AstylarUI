...
const styles: StyleRule[] = [
  ...
  { selector: '#selected-download', width: '42px', height: '21px', background: 'transparent', color: '#7d8590', borderWidth: '0' },
  ...
  { selector: '.history-item small', display: 'flex', justifyContent: 'space-between', height: '16px', margin: '3px 0 2px', lineHeight: '16px', color: '#7d8590' },
