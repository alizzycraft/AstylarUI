...
test('audit projection rejects retained behavior changes, import aliases and orchestration coupling', () => {
  ...
  const mutations = [
    ...
    s => s.replace('applyRetainedFontScalar, validateRetainedFontScalar', 'applyRetainedFontScalar as unexpected, validateRetainedFontScalar'),
    s => s.replace('applyRetainedFontScalar, validateRetainedFontScalar', 'applyRetainedFontScalar, unexpectedMember, validateRetainedFontScalar'),
    s => s + '\nconst unreviewedFontCoupling = applyRetainedFontScalar;\n',
    s => s.replace('applySidenavBackgroundScalar, validateSidenavBackgroundScalar', 'applySidenavBackgroundScalar as unexpected, validateSidenavBackgroundScalar'),
    s => s.replace('applySidenavBackgroundScalar, validateSidenavBackgroundScalar', 'applySidenavBackgroundScalar, unexpectedMember, validateSidenavBackgroundScalar'),
    s => s + '\nconst unreviewedSidenavCoupling = applySidenavBackgroundScalar;\n',
    ...
    s => s.replace('collectOverlaySurfaceAuditInputs, applyOverlaySurfaceAuditRows', 'collectOverlaySurfaceAuditInputs as unexpected, applyOverlaySurfaceAuditRows'),
    s => s.replace('collectOverlaySurfaceAuditInputs, applyOverlaySurfaceAuditRows', 'collectOverlaySurfaceAuditInputs, unexpectedMember, applyOverlaySurfaceAuditRows'),
    s => s + '\nconst unreviewedOverlayCoupling = collectOverlaySurfaceAuditInputs;\n',
