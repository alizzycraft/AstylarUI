...
const implemented = declarations[0].getText(ast);
const original = conserveDisabledInkGuard(implemented).source;
...
assert.equal(implemented, proposed, 'production classifier must use the exact reviewed decimal guard');
