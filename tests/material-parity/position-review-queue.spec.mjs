...
test('position queue accounts for every original group without claiming canonical acceptance', () => {
  ...
  assert.deepEqual(q.counts['producer-integrated-conservation-pending'], { groups: 14, observations: 768 });
  assert.deepEqual(q.counts['historical-export-conserved'], { groups: 6, observations: 316 });
