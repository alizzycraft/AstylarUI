...
function implementationPlan() {
  return [
    ...
    { priority: 3, rootCause: 'Fixture outcome compensation', action: 'Replace fixed family heights, absolute flow placement, responsive/DPR offsets, and duplicated measured dimensions with the same layout declarations and structure used by the reference. Run the minimal browser reductions and complete compositions; let newly honest failures identify the owning core subsystem.' },
