...
test('complete Material audit plan includes every discovered suite and every legacy test', () => {
  ...
  assert.ok(plan.additionalFiles.includes('tests/material-parity/container-font-inputs.spec.mjs'));
  assert.ok(plan.additionalFiles.includes('tests/material-parity/leaf-font-stages.spec.mjs'));
